...
for SYM in PID_NS DEBUG_KINFO DEBUG_KERNEL DEBUG_LIST \
           USB_DWC3_MSM USB_F_GSI USB_CONFIGFS_F_GSI USB_BAM \
           LRU_GEN LRU_GEN_ENABLED NET_SCH_FQ DEBUG_MEMORY_INIT PRINTK_CALLER \
           ZPOOL ZSMALLOC DEBUG_INFO DEBUG_INFO_DWARF4 DEBUG_INFO_BTF DEBUG_INFO_BTF_MODULES DEBUG_FS \
